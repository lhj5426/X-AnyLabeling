...
class SmartGuidesDialog(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None, config=None):
        ...
        self.setMinimumWidth(480)  # 单列布局，减小宽度
        self.setMinimumHeight(550)  # 优化后的高度
    ...
    def init_ui(self):
        ...
        # 🎯 辅助线方向显示开关（紧凑布局，与上面对齐）
        show_direction_layout = QtWidgets.QHBoxLayout()
        show_direction_layout.setSpacing(10)
        show_direction_layout.setContentsMargins(0, 0, 0, 0)  # 不缩进，与上面对齐
        ...
        direction_layout.setContentsMargins(0, 0, 0, 0)  # 不缩进，与上面对齐
        ...
        # 🎯 粘贴模式方向吸附开关（紧凑布局，与上面对齐）
        paste_direction_layout = QtWidgets.QHBoxLayout()
        paste_direction_layout.setSpacing(10)
        paste_direction_layout.setContentsMargins(0, 0, 0, 0)  # 不缩进，与上面对齐
